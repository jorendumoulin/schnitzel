...
def get_all_snax_passes() -> dict[str, Callable[[], type[ModulePass]]]:
    ...
    def get_tosa_combine_rescale():
        from snaxc.transforms.combine_rescale import TosaCombineRescale

        return TosaCombineRescale
    ...
    def get_convert_float_to_hardfloat():
    ...
    def get_phs_divf_constant_to_mul():
