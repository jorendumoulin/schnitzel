...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<64xi32, "L3">, %arg1: memref<64xi32, "L3">, %arg2: memref<64xi32, "L3">):
...
//CHECK-NEXT:   ^bb0(%arg0: memref<64xi32, "L3">, %arg1: memref<64xi32, "L3">, %arg2: memref<64xi32, "L3">):
...
//CHECK-NEXT:     ^bb1(%arg3: i32, %arg4: i32, %arg5: i32):
...
"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<64xi32, "L3">, %arg1: memref<64xi32, "L3">, %arg2: memref<64xi32, "L3">):
    ...
    ^bb2(%arg3_1: i32, %arg4_1: i32, %arg5_1: i32):
...
//CHECK-NEXT:     ^bb2(%arg3_1: i32, %arg4_1: i32, %arg5_1: i32):
