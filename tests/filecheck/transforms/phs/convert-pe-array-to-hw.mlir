...
phs.pe_array @myacc_array(%0 : !hw.array<4xi32>, %1 : !hw.array<4xi32>, %2 : index) -> (!hw.array<4xi32>) {
  ...
  %14 = arith.constant 3 : i2
  phs.yield %13, %14 : !hw.array<2xi32>, i2
}
...
// The PE array module with hw.instance ops, data output, and a per-output mask
// CHECK: hw.module @myacc_array(in %0 data_0: !hw.array<4xi32>, in %1 data_1: !hw.array<4xi32>, in %2 switch_0: i1, out out_0: !hw.array<2xi32>, out mask_0: i2) {
