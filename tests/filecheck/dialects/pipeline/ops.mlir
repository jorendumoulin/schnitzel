...
builtin.module {
  ...
  scf.for %i = %lb to %ub step %step {
    pipeline.pipeline {
      ...
      ^bb1(%7: memref<1x2xi32>, %8: memref<1x2xi32>):
...
// CHECK-NEXT:       ^bb1(%7: memref<1x2xi32>, %8: memref<1x2xi32>):
...
// CHECK-GENERIC-NEXT:       ^bb2(%7: memref<1x2xi32>, %8: memref<1x2xi32>):
